...
/**
 * Created by yangxiaoguang on 2017/4/9.
 */
...
public class GPS_Server {
    ...
    public GPS_Server(Context context, GPSCallBack gpsCallBack)
    {
    ...
    private BDLocationListener listener = new BDLocationListener() {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            gpsCallBack.UpdateGpsLocation(location);
    ...
    {
        void UpdateGpsLocation(BDLocation location);
    }
}
